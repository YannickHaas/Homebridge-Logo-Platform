...
exports.BlindPlatformAccessory = void 0;
...
class BlindPlatformAccessory {
    ...
    async setTargetPosition(value) {
        ...
        let qItem = new queue_1.QueueSendItem(this.device.blindSetTargetPos, this.blindLogoPosToHomebridgePos(value, this.device.blindConvertValue), 0);
    ...
    updateCurrentPosition() {
        ...
        let qItem = new queue_1.QueueReceiveItem(this.device.blindGetPos, async (value) => {
            if (value != error_1.ErrorNumber.noData) {
                this.accStates.CurrentPosition = this.blindLogoPosToHomebridgePos(value, this.device.blindConvertValue);
                if (this.platform.config.debugMsgLog || this.device.debugMsgLog) {
    ...
    updatePositionState() {
        ...
        let qItem = new queue_1.QueueReceiveItem(this.device.blindGetState, async (value) => {
            if (value != error_1.ErrorNumber.noData) {
                this.accStates.PositionState = this.blindLogoStateToHomebridgeState(value, this.device.blindConvertValue);
                if (this.platform.config.debugMsgLog || this.device.debugMsgLog) {
    ...
    updateTargetPosition() {
        ...
        let qItem = new queue_1.QueueReceiveItem(this.device.blindGetTargetPos, async (value) => {
            if (value != error_1.ErrorNumber.noData) {
                this.accStates.TargetPosition = this.blindLogoPosToHomebridgePos(value, this.device.blindConvertValue);
                if (this.platform.config.debugMsgLog || this.device.debugMsgLog) {
    ...
    blindLogoPosToHomebridgePos(value, convert) {
        if (convert) {
            return (100 - value);
        }
        else {
    ...
    blindLogoStateToHomebridgeState(value, convert) {
        /*
         * LOGO!
         * 0 - STOPP
         * 1 - UP   -> more open  -> 0%
...
exports.BlindPlatformAccessory = BlindPlatformAccessory;
//# sourceMappingURL=blindPlatformAccessory.js.map